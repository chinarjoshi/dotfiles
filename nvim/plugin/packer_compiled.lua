...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "null-ls.nvim", "lspkind-nvim", "nvim-autopairs", "LuaSnip" },
    load_after = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lightspeed.nvim', 'vim-commentary', 'friendly-snippets', 'vim-repeat', 'vim-surround', 'nvim-colorizer.lua', 'stabilize.nvim', 'targets.vim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
