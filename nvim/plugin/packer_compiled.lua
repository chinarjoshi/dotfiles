...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "LuaSnip", "lspkind-nvim", "null-ls.nvim" },
    load_after = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'stabilize.nvim', 'indent-blankline.nvim', 'targets.vim', 'lightspeed.nvim', 'vim-commentary', 'friendly-snippets', 'vim-repeat', 'vim-surround', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
