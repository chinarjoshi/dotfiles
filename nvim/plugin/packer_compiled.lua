...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "lspkind-nvim", "nvim-autopairs", "null-ls.nvim", "LuaSnip" },
    load_after = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'stabilize.nvim', 'targets.vim', 'indent-blankline.nvim', 'lightspeed.nvim', 'vim-commentary', 'vim-surround', 'nvim-colorizer.lua', 'vim-repeat', 'friendly-snippets'}, { event = "BufRead *" }, _G.packer_plugins)]]
