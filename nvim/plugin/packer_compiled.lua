...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'targets.vim', 'indent-blankline.nvim', 'lightspeed.nvim', 'vim-repeat', 'vim-surround', 'vim-commentary', 'stabilize.nvim', 'friendly-snippets', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
