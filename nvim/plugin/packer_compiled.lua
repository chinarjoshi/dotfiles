...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-commentary', 'indent-blankline.nvim', 'lightspeed.nvim', 'friendly-snippets', 'targets.vim', 'vim-repeat', 'nvim-colorizer.lua', 'stabilize.nvim', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
