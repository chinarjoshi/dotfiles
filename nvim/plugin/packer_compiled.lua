...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'lightspeed.nvim', 'stabilize.nvim', 'vim-commentary', 'friendly-snippets', 'nvim-colorizer.lua', 'vim-repeat', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
