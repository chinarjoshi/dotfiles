...
local no_errors, error_msg = pcall(function()
  ...
  _G.packer_plugins = {
    ...
    ['cmp-nvim-lsp'] = {
      after = { 'cmp-buffer' },
      after_files = {
        '/home/c/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp/after/plugin/cmp_nvim_lsp.lua',
      },
      load_after = {
        ['cmp-nvim-lua'] = true,
      },
    ...
    ['cmp-nvim-lua'] = {
      after = { 'cmp-nvim-lsp' },
      after_files = {
        '/home/c/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua',
      },
      load_after = {
        cmp_luasnip = true,
      },
    ...
    cmp_luasnip = {
      after = { 'cmp-nvim-lua' },
      after_files = {
        '/home/c/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua',
      },
      load_after = {
        LuaSnip = true,
      },
