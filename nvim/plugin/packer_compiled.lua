...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "lspkind-nvim", "null-ls.nvim", "LuaSnip", "nvim-autopairs" },
    load_after = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lightspeed.nvim', 'vim-commentary', 'vim-repeat', 'vim-surround', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'targets.vim', 'friendly-snippets', 'stabilize.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
