...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'vim-surround', 'friendly-snippets', 'nvim-colorizer.lua', 'lightspeed.nvim', 'indent-blankline.nvim', 'vim-commentary', 'stabilize.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
