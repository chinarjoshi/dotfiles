...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "lspkind-nvim", "nvim-autopairs", "LuaSnip" },
    load_after = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'stabilize.nvim', 'targets.vim', 'friendly-snippets', 'indent-blankline.nvim', 'lightspeed.nvim', 'vim-repeat', 'vim-surround', 'vim-commentary', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
