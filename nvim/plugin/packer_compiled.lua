...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'friendly-snippets', 'indent-blankline.nvim', 'targets.vim', 'stabilize.nvim', 'lightspeed.nvim', 'vim-commentary', 'vim-repeat', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
