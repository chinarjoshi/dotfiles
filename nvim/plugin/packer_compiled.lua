...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'indent-blankline.nvim', 'vim-surround', 'lightspeed.nvim', 'vim-commentary', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
