...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "lspkind-nvim", "null-ls.nvim", "nvim-autopairs", "LuaSnip" },
    load_after = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'targets.vim', 'indent-blankline.nvim', 'lightspeed.nvim', 'vim-commentary', 'vim-repeat', 'vim-surround', 'nvim-colorizer.lua', 'stabilize.nvim', 'friendly-snippets'}, { event = "BufRead *" }, _G.packer_plugins)]]
