...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "lspkind-nvim", "LuaSnip", "null-ls.nvim" },
    load_after = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'lightspeed.nvim', 'friendly-snippets', 'stabilize.nvim', 'targets.vim', 'vim-repeat', 'vim-commentary'}, { event = "BufRead *" }, _G.packer_plugins)]]
