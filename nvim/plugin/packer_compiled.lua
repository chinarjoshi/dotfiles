...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'vim-commentary', 'indent-blankline.nvim', 'lightspeed.nvim', 'vim-surround', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
